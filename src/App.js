...
function App() {
  return (
    <div className=" bg-white dark:bg-gradient-to-r from-black to-gray-900">
      ...
      <footer id="Contacto">
        <section className='relative flex flex-col bg-gray-800 items-center justify-center w-full h-96 md:h-60 lg:h-96 px-5 lg:px-10 overflow-hidden rounded-sm'>
          <div className='font-roboto space-y-2 z-40'>
            <p className='text-gray-200 text-sm lg:text-base'>-El trabajo es más fácil en equipo 👨‍💼-</p>
            <h3 className='text-2xl lg:text-4xl font-bold text-cyan-300 text-center'>Contáctame</h3>
          </div>
            ...
            <div className='flex pt-4 gap-7'>
              ...
              <li className='list-none hover:scale-150 duration-200'>
                <a className='pt-5' href="/JesusEcheverria.github.io/Documents/CV_JN.pdf" target="_blank" rel="noopener noreferrer">
                  <svg className='w-4 animate-bounce fill-black fill-yellow-200' viewBox="0 0 24 24" fillRule="evenodd">
