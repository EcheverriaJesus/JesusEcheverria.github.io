...
{/* Tarjetas de proyectos */}
        <div className='flex flex-col items-center w-full h-auto  p-5 rounded-lg shadow-lg bg-[#f2f7ff]'>
       <div className='flex pb-5'>
         <img className="h-auto w-full rounded-lg hover:scale-[0.97] ease-in duration-300" src="/JesusEcheverria.github.io/Images/Page_Developers_iti.jpg" alt="" />
       </div>
       <div className='flex flex-col pb-5'>
         <h2 className='font-bold text-3xl md:text-3xl text-blue-700 text-center pb-5'>SCHOOL BOOK</h2>

         <p className='text-justify font-normal text-base text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam culpa accusamus officia quia exercitationem esse ratione qui, minima in perferendis error iusto quos sequi possimus non doloremque voluptatem, ipsa minus.</p>
       </div>
