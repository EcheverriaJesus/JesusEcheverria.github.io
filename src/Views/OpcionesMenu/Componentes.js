  ...
  return (
    <div className='flex items-center flex-col 2xl:justify-center'>
      ...
      <section className='grid grid-cols-1 w-full pt-14 gap-16 md:grid-cols-2 md:gap-10 lg:grid-cols-2'>
        <ProjectComponent title='UIVERSE 🚀' description='Encontraras botones y cards para poder utilizar en tus proyectos.' url='https://uiverse.io/profile/EcheverriaJesus' img='../../Images/Readme/UIVERSE.png' />
        <ProjectComponent title='Blog 📝' description='Te compartó los paso para traducir Laravel Breeze y/o Jetstream a español.' url='https://dev.to/echeverriajesus/breeze-y-jetstream-en-espanol-4onn' img='../../Images/Readme/JBEspañol.png' />
