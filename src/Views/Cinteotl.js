  ...
  return (
    ...
    <div className='flex flex-col md:flex-row-reverse md:items-center md:gap-14 lg:h-full'>
      ...
      <section className='flex flex-col w-full text-justify space-y-3 md:w-4/12'>
        ...
        <h3 className='text-sm text-justify font-semibold te border-b pb-5'>Este proyecto fue mi primera experiencia en el desarrollo web.</h3>
        <p className='font-normal text-xs text-justify text-slate-700'>Cinteotl trata a cerca de la administración de un restaurante, en este proyecto se llevo a cabo la vista final del cliente con un menú web,asi como tambien la parte del backoffice para los administradores</p>
