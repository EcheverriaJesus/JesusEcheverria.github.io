  ...
  return (
    ...
    <div className='flex flex-col md:flex-row-reverse md:items-center md:gap-14 lg:h-full'>
      ...
      <section className='flex flex-col w-full text-justify space-y-3 md:w-4/12'>
        ...
        <h3 className='text-sm text-justify font-semibold te border-b pb-5'>He llevado a cabo este pequeño proyecto con el propósito de fortalecer mi conocimiento en el framework Laravel.</h3>
