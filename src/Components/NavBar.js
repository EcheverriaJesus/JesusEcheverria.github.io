          ...
          <ul className='space-y-3 lg:flex lg:space-x-5 lg:space-y-0'>
            {
              Links.map((link, index) => (
                <li key={index}>
                  ...
                  <a onClick={scrollToSection} className='text-gray-700 hover:text-yellow-400 duration-500 hover:border-b border-gray-600 hover:pb-1 dark:text-gray-300 dark:hover:text-yellow-300' href={link.section}>{link.name}</a>
                  {/*  </Link> */}
                </li>
              ))
            }
