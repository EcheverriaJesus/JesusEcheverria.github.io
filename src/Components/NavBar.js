      ...
      <section className={`transition-all duration-300 ${abierto ? 'block' : 'hidden'} pt-3 lg:flex lg:items-center lg:w-auto`}>
            ...
            Links.map((link, index) => (
              <li key={index}>
                <Link
                  ...
                  duration={500}
                  onClick={closeMenu}
                  className='text-gray-700 hover:font-semibold duration-500 dark:text-gray-300 dark:hover:text-yellow-300' href={link.section}>{link.name}</Link>
              </li>
            ))
          }
        </ul>
        ...
        <div className='flex pt-4 gap-2 lg:ml-4 lg:pt-0 lg:pl-4'>
          ...
          <li className='list-none hover:scale-150 duration-200'>
            <a className='pt-5' href="/JesusEcheverria.github.io/Documents/CV_JN_ECHEVERRIA.pdf" target="_blank" rel="noopener noreferrer">
