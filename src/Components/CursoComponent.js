...
export default function CursoComponent(props) {
    return (
        <div className="relative pl-8 sm:pl-32 py-6 group">
            <div className="font-caveat font-medium text-2xl text-indigo-600 mb-1 sm:mb-0 dark:text-yellow-300">{ props.title }<span className='pl-3 text-sm text-indigo-500 dark:text-yellow-400'>{ props.next }</span></div>
