    ...
    return (
            ...
            <div className='flex flex-col w-full h-80 rounded-b-2xl shadow-2xl bg-white pb-5 mb-5'>
                ...
                <div className='flex flex-col h-1/2 px-5 my-4'>
                    ...
                    <p className='font-normal text-slate-500 text-xs pb-3'>Laravel, Tailwind CSS & Livewire</p>
                    <div className='flex justify-center'>
                        <div className='flex gap-2 py-2 px-5 rounded-2xl cursor-pointer bg-[#e3fff9] hover:scale-[1.1] ease-in duration-300 mb-3 hover:text-black hover:font-semibold'>
