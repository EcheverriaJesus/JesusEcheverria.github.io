...
export default function Logo_Tecnology(props) {
  return (
    <div className="flex justify-center items-center">
       <svg className="flex w-12 h-12 sm:w-20 h-20 md:w-28 h-28 lg:w-32 h-32 App-logo" id="SvgjsSvg2170" viewBox="0 0 499.772 499.772">
        <path
        ...
        <defs>
          <linearGradient gradientTransform="rotate(0 0.5 0.5)" id="SvgjsLinearGradient2171">
            ...
            <stop stopOpacity=" 1" stopColor="#F0FFFF" offset="0.48"></stop>
