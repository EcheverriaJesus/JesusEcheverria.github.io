...
export default function Logo_Tecnology(props) {
  return (
    <div className="flex justify-center items-center">
       <svg className="flex absolute App-logo w-12 h-12 sm:w-24 h-28 md:w-32 h-32" id="SvgjsSvg2170" viewBox="0 0 499.772 499.772" width="200" height="200">
        <path
      ...
      <img className="flex absolute h-6 sm:h-12 md:h-14 lg:h-16" src={ props.image} alt="" />
    </div>
  );
}
