    ...
    <div className='px-12 md:px-24 space-y-20'>
      <section className='flex flex-col justify-between items-center w-full md:flex-row'>
        <div className='w-full text-justify space-y-3 md:w-5/12'>
          <h3 className='text-center font-bold text-3xl md:text-5xl text-blue-600 md:text-justify'>Laravel Course</h3>
          <h3 className='font-bold text-base md:text-lg'>Course in the Tecnológico Nacional de México Campus Iguala with a classmate.</h3>
