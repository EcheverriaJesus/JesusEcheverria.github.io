    ...
    <div className='px-12 md:px-24 space-y-20'>
      <section className='flex flex-col justify-between items-center w-full md:flex-row'>
        <div className='w-full text-justify space-y-3 md:w-5/12' data-aos="fade-up" data-aos-delay="100" data-aos-duration="900">
          <h3 className='text-center font-bold text-3xl md:text-5xl text-blue-700 md:text-justify'>Curso Laravel</h3>
          ...
          <p className='space-y-4 text-base leading-6 text-gray-600'>Esta experiencia me ayudó a obtener una comprensión más profunda de esta tecnología y me brindó la oportunidad de compartir mis conocimientos con otras personas, mejorando mis habilidades de enseñanza en el proceso.</p>
