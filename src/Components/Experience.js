  ...
  return (
    <div>
      ...
      <section className='flex flex-col items-center px-10 pb-7 pt-20'>
        ...
        <div className='flex flex-col gap-8 pt-24 w-full md:flex-row lg:px-40' data-aos="fade-up" data-aos-delay="100" data-aos-duration="900">

          <article className='flex gap-5 py-10 md:w-8/12 md:py-0'>
          ...
          <article className='flex gap-5 md:w-7/12'>
            <div className="bg-blue-800 w-10 h-10 p-2 rounded-xl">
