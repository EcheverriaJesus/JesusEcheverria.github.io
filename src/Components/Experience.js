    ...
    <div>
      ...
      <section className='flex flex-col items-center px-8 pb-7 md:px-12 md:pt-10 lg:px-24 lg:pt-20'>
        <div className='text-justify md:text-center' data-aos="zoom-in-left" data-aos-delay="100" data-aos-duration="900">
          <h3 className='font-bold text-blue-700 text-center text-base md:text-lg'>Autodidacta</h3>
          ...
          <div className='flex gap-5 md:w-7/12'>
            ...
            <div>
              ...
              <div className='grid grid-cols-5 gap-6 pt-5 md:grid-cols-6'>
                <img className='hover:scale-150 ease-in duration-300 h-10' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Electron.png" alt="" />
