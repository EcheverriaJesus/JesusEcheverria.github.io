          ...
          <div className='flex gap-5 md:w-9/12'>
            ...
            <div>
              ...
              <div className='grid grid-cols-5 gap-6 pt-5 md:grid-cols-6'>
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Electronjs.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/Logos/Laravel.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/React.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Asp.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Node.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Livewire.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Sass.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-10 w-10' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Tailwind.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Bootstrap.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Android.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/C.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-10 w-10' src="/JesusEcheverria.github.io/Images/Logos/Java.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/Logos/Git.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/Logos/Blender.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Canva.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Figma.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Lucid.png" alt="" />
                <img className='hover:scale-150 ease-in duration-300 h-8 w-8' src="/JesusEcheverria.github.io/Images/LogoHerramientas/Monday.png" alt="" />
              </div>
