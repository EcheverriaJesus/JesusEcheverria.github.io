    ...
    <div>
      ...
      <section className='flex flex-col items-center px-8 pb-7 md:px-12 md:pt-10 lg:px-24 lg:pt-20'>
        <div className='text-justify md:text-center'>
          <h3 className='font-bold text-blue-700 text-base md:text-lg'>Autodidacta</h3>
          <h2 className='font-bold text-3xl md:text-3xl text-blue-800 pb-4'>Cada día me gusta aprender cosas nuevas</h2>
          <p className='space-y-4 text-base leading-7 text-gray-600 lg:px-44'>Soy una persona muy curiosa con las tecnologias, gracias a esto he tenido la experiencia en muchas plataformas, plataformas que usan Inteligencia Artificial, Diseño, Administración en el proceso del desarrollo de software, lenguajes de programación, etc. Además de mis proyectos anteriores tengo la experiencia de trabajar con muchas otras herramientas.</p>
        </div>

        <div className='flex flex-col w-full gap-20 justify-between pt-24 md:flex-row'>
          <div className='flex gap-5 w-1/2'>
            ...
            <div>
              ...
              <p className='space-y-4 text-base text-justify leading-7 text-gray-600'>Soy una persona muy curiosa con las tecnologias, gracias a esto he tenido la experiencia en muchas plataformas, plataformas que usan Inteligencia Artificial, Diseño.</p>
            </div>
          </div>
