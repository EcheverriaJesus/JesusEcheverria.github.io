...
import { Title3D, TitleCrud, TitleDevelopers, TitleCinteolt, TitleSchoolBook, UrlImg } from '../Variables/Variables'
...
export default function Experience() {
  ...
  return (
    <div>
      ...
      <section className='flex flex-col justify-center text-center w-auto h-auto px-5 py-10 mb-8 md:mx-12 duration-700 lg:mx-24 md:px-12 bg-gray-800 md:rounded-xl dark:bg-slate-600'>
      ...
      <section className='flex flex-col items-center px-10 pb-7 pt-20'>
        <article className='text-justify md:text-center' data-aos="zoom-in-left" data-aos-delay="100" data-aos-duration="900">
        ...
        <div className='flex flex-col gap-8 pt-24 w-full md:flex-row lg:px-40 bg-blue-200' data-aos="fade-up" data-aos-delay="100" data-aos-duration="900">

          <article className='flex gap-5 py-10 md:w-8/12 md:py-0 bg-yellow-200'>
          ...
          <article className='flex gap-5 md:w-7/12 bg-red-300'>
            <div className="bg-blue-800 w-10 h-10 p-2 rounded-xl">
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-10 pt-5 '>
                <NameSpan img={UrlImg + 'Electronjs.png'} name="Electron.js" />
                <NameSpan img={UrlImg + 'Laravel.png'} name="Laravel" />
                <NameSpan img={UrlImg + 'React.png'} name="React.js" />
                <NameSpan img={UrlImg + 'Asp.png'} name="Asp.net" />
                <NameSpan img={UrlImg + 'Node.png'} name="Node.js" />
                <NameSpan img={UrlImg + 'Livewire.png'} name="Livewire" />
                <NameSpan img={UrlImg + 'Sass.png'} name="Sass" />
                <NameSpan img={UrlImg + 'Tailwind.png'} name="TailwindCss" />
                <NameSpan img={UrlImg + 'Bootstrap.png'} name="Bootstrap" />
                <NameSpan img={UrlImg + 'Android.png'} name="Android" />
                <NameSpan img={UrlImg + 'C.png'} name="C#" />
                <NameSpan img={UrlImg + 'Java.png'} name="Java" />
                <NameSpan img={UrlImg + 'Git.png'} name="Git" />
                <NameSpan img={UrlImg + 'Blender.png'} name="Blender" />
                <NameSpan img={UrlImg + 'Canva.png'} name="Canva" />
                <NameSpan img={UrlImg + 'Figma.png'} name="Figma" />
                <NameSpan img={UrlImg + 'Lucid.png'} name="Lucid" />
                <NameSpan img={UrlImg + 'Monday.png'} name="Monday" />
              </div>
